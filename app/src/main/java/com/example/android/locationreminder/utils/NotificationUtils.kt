...
import com.example.android.locationreminder.ui.reminder.DetailsActivity

private const val NOTIFICATION_CHANNEL_ID = BuildConfig.APPLICATION_ID + ".channel"

fun sendNotification(context: Context, reminderDataItem: Reminder) {
    ...
    val intent = DetailsActivity.newIntent(context.applicationContext, reminderDataItem)
